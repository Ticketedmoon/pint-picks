      ...
      <div className="mx-auto w-full max-w-md rounded-xl bg-white p-6 shadow-2xl sm:rounded-2xl sm:p-8">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-3 rounded-xl border-2 border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 transition-all hover:border-gray-400 hover:bg-gray-50 disabled:opacity-50 sm:text-base"
          >
